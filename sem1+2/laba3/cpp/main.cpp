...
int main()
{
    ...
    for(int i = 0; i < size; i++)
    {
        cout << komisias[i]<<endl;
    }
    

    //маассив объектов Student
    cout << "\n\n=== КЛАСС Student ===" << endl;
    cout << "Введите размер массива: ";
    cin >> size;
    rewind(stdin);
    ...
    cout<< "средний бал егора: "<< stud.get_sr_bal();
    cout << "степендия егора: " << stud.get_stependiya();
    ...
    cout<< "новый средний бал егора: "<< stud.get_sr_bal();
    cout << "новый степендия егора: " << stud.get_stependiya();
