...
class Prepod: virtual public Human
{
    ...
    {
        strncpy(this->dolgnost, other.dolgnost, M);
        strncpy(this->specialnost, other.specialnost, M);
        strncpy(this->truds, other.truds, M);
        this->dolgnost[M - 1] = '\0';
        this->specialnost[M - 1] = '\0';
        this->truds[M - 1] = '\0';
    }
    ...
    friend istream &readFromFile(istream &in, Prepod &obj);
    friend ostream &writeToFile(ostream &out, const Prepod &obj);
