...
void Interface<T>::menu()
{
    ...
    do
    {
        ...
        choice = validator.inputNumber(0, 5);
...
void Interface<T>::fun()
{
    ...
    do
    {
        ...
        choice = validator.inputNumber(0, 7);
        ...
        {
            T obj;
            cin >> obj;  // Исключения обрабатываются внутри методов ввода
            och.pushback(obj);
        ...
        case 3:
        {
            ...
            index = validator.inputNumber(1, och.getSize());
