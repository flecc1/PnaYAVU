...
/**
 * @class Book
 * @brief Класс книги, наследуется от LibraryItem
 * 
 * Представляет печатную книгу с дополнительными характеристиками:
 * количество страниц, ISBN номер и издательство.
 * Является базовым классом для специализированных типов книг.
 */
